...
| 004_streak_functions.sql | Streak Fix | Accurate streak calculation via Supabase function + trigger. Auto-fires on habit_log insert/delete. Backfills all existing habits. |
